...
<body>
    ...
    <section class="shop" id="shop">
        <div class="title">
            ...
            <p>Discover the perfect blend of quality and flavor with our premium dog food — because your pet deserves
                the best!</p>
        </div>
        <div class="content">
            <div class="box">
            ...
            <div class="box">
                <div class="imgbx">
                    <img src="https://static.wixstatic.com/media/84770f_b29b9b581f7743aa9b5aafd7c2f8398c~mv2_d_2635_2710_s_4_2.png/v1/fill/w_246,h_253,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/84770f_b29b9b581f7743aa9b5aafd7c2f8398c~mv2_d_2635_2710_s_4_2.png"
                        alt="">
                </div>
                <div class="text">
        ...
        <div class="imgtext">
            ...
            <div class="info">
                <div class="infocontent">
                    ...
                    <p>"Nourish your pet with the power of nature — made with fresh, natural ingredients for a
                        healthier, happier life"</p>
                </div>
                <div class="infocontent">
                    <h3>100% HOME MADE</h3>
                    <p>"Homemade with love — our dog food is crafted with care, using only the finest ingredients from
                        our kitchen to your pet's bowl"</p>
                </div>
                <div class="infocontent">
                    <h3>SOURCED IN INDIA</h3>
                    <p>"Proudly sourced in the INDIA — we ensure top-quality, responsibly sourced ingredients for your
                        furry friend's meals"</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="review" id="review">
        ...
        <div class="container">
            ...
            <div class="cbox4 bbox">
                <div class="boxdetail">
                    <h1>COOKIE</h1>
                    <p> My human started feeding me this food a while ago, and I can’t get enough of it! It tastes soooo
                        good, and I finish my bowl every time. My coat is shinier, and I have tons of energy to play all
                        day long! It’s the best food ever!</p>
                </div>
            </div>
            <div class="cbox5 bbox">
                <div class="boxdetail">
                    <h1>JACKSON</h1>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe, voluptatem amet? Omnis
                        exercitationem esse quos, voluptate praesentium minus est voluptas tenetur iusto nulla tempore
                        consequuntur, natus dicta repellat officiis dolor!</p>
                </div>
            </div>
            ...
            <div class="cbox7 bbox">
                <div class="boxdetail">
                    <h1>BOLT</h1>
                    <p>I just tried Barky Bites Gourmet Chicken Feast—it’s pawsome! 🐶🍖 Crunchy, juicy, and
                        oh-so-chickeny. My tail wagged non-stop, and I’ve got energy for days! 🐕✨ Five paws up! </p>
                </div>
            </div>
    ...
    <section class="contact" id="contact">
        <div class="footer">
            ...
            <div class="info">
                <h1>INFORMATION</h1>
                <p>Transparency is key — our dog food is made with carefully selected ingredients, and we provide all
                    the information you need about where each component comes from, how it's processed, and why it’s
                    perfect for your pet’s health. Trust us to deliver high-quality nutrition in every meal.</p>
            </div>
            <div class="cs">
            ...
            <div class="slinks">
                <h1>FOLLOW US</h1>
                <div class="link">
                    <a href="https://www.linkedin.com/in/prajit-kotal-0707112b3?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app/"
                    ...
                    <a href="https://www.instagram.com/prajit__k?igsh=MWg0bjV4a24zbTdzdg==" target="_blank"><i
